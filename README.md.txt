# Sistema de gestión estudiantil (ejercicio transversal integrador)

Proyecto académico para la materia **Ingeniería de Software**, cuyo objetivo es diseñar y documentar un **Sistema de Gestión Estudiantil** para la Universidad.  
...
- `documentacion/` → contiene los prácticos en PDF y diagramas UML.
- `README.md` → descripción breve del proyecto.  

## Entregables prácticos
- **Práctico 1** → Análisis inicial, actores, requisitos, backlog y diagrama UML.  

## Equipo (nro 7)
- [adrb1806](https://github.com/adrb1806) Barone, Adrian  
- [AgustinaHernandez](https://github.com/adrb1806) Hernández, Agustina
